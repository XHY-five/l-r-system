...
public:
    ...
    void setupUi(QDialog *ChatDialog)
    {
        ...
        side_content_lb = new QLabel(widget);
        side_content_lb->setObjectName("side_content_lb");
        side_content_lb->setMinimumSize(QSize(30, 30));
        side_content_lb->setMaximumSize(QSize(30, 30));

        verticalLayout_3->addWidget(side_content_lb);
    ...
    void retranslateUi(QDialog *ChatDialog)
    {
        ...
        side_content_lb->setText(QString());
