...
static constexpr auto qt_meta_stringdata_ZN10ClickedBtnE = QtMocHelpers::stringData(
    "ClickedBtn"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10ClickedBtnE[] = {
...
Q_CONSTINIT const QMetaObject ClickedBtn::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10ClickedBtnE.offsetsAndSizes,
    qt_meta_data_ZN10ClickedBtnE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10ClickedBtnE_t,
        // Q_OBJECT / Q_GADGET
...
void *ClickedBtn::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10ClickedBtnE.stringdata0))
