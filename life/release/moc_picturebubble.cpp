...
static constexpr auto qt_meta_stringdata_ZN13PictureBubbleE = QtMocHelpers::stringData(
    "PictureBubble"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13PictureBubbleE[] = {
...
Q_CONSTINIT const QMetaObject PictureBubble::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13PictureBubbleE.offsetsAndSizes,
    qt_meta_data_ZN13PictureBubbleE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13PictureBubbleE_t,
        // Q_OBJECT / Q_GADGET
...
void *PictureBubble::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13PictureBubbleE.stringdata0))
