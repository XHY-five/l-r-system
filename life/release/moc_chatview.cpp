...
static constexpr auto qt_meta_stringdata_ZN8ChatViewE = QtMocHelpers::stringData(
    "ChatView",
    "onVScrollBarMoved",
    "",
    "min",
...
Q_CONSTINIT static const uint qt_meta_data_ZN8ChatViewE[] = {
...
Q_CONSTINIT const QMetaObject ChatView::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8ChatViewE.offsetsAndSizes,
    qt_meta_data_ZN8ChatViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8ChatViewE_t,
        // Q_OBJECT / Q_GADGET
...
void *ChatView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8ChatViewE.stringdata0))
