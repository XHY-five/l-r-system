...
static constexpr auto qt_meta_stringdata_ZN11ChatUserWidE = QtMocHelpers::stringData(
    "ChatUserWid"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11ChatUserWidE[] = {
...
Q_CONSTINIT const QMetaObject ChatUserWid::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11ChatUserWidE.offsetsAndSizes,
    qt_meta_data_ZN11ChatUserWidE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11ChatUserWidE_t,
        // Q_OBJECT / Q_GADGET
...
void *ChatUserWid::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11ChatUserWidE.stringdata0))
