...
static constexpr auto qt_meta_stringdata_ZN12ChatItemBaseE = QtMocHelpers::stringData(
    "ChatItemBase"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ChatItemBaseE[] = {
...
Q_CONSTINIT const QMetaObject ChatItemBase::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ChatItemBaseE.offsetsAndSizes,
    qt_meta_data_ZN12ChatItemBaseE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ChatItemBaseE_t,
        // Q_OBJECT / Q_GADGET
...
void *ChatItemBase::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ChatItemBaseE.stringdata0))
