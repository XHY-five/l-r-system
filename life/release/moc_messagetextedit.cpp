...
static constexpr auto qt_meta_stringdata_ZN15MessageTextEditE = QtMocHelpers::stringData(
    "MessageTextEdit",
    "send",
    "",
    "textEditChanged"
...
Q_CONSTINIT static const uint qt_meta_data_ZN15MessageTextEditE[] = {
...
Q_CONSTINIT const QMetaObject MessageTextEdit::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN15MessageTextEditE.offsetsAndSizes,
    qt_meta_data_ZN15MessageTextEditE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN15MessageTextEditE_t,
        // Q_OBJECT / Q_GADGET
...
void MessageTextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (MessageTextEdit::*)();
            if (_q_method_type _q_method = &MessageTextEdit::send; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *MessageTextEdit::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN15MessageTextEditE.stringdata0))
