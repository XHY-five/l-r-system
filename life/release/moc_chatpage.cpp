...
static constexpr auto qt_meta_stringdata_ZN8ChatPageE = QtMocHelpers::stringData(
    "ChatPage",
    "on_send_btn_clicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN8ChatPageE[] = {
...
Q_CONSTINIT const QMetaObject ChatPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN8ChatPageE.offsetsAndSizes,
    qt_meta_data_ZN8ChatPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8ChatPageE_t,
        // Q_OBJECT / Q_GADGET
...
void *ChatPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN8ChatPageE.stringdata0))
