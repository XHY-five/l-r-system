...
static constexpr auto qt_meta_stringdata_ZN12ChatUserListE = QtMocHelpers::stringData(
    "ChatUserList",
...
Q_CONSTINIT static const uint qt_meta_data_ZN12ChatUserListE[] = {
...
Q_CONSTINIT const QMetaObject ChatUserList::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12ChatUserListE.offsetsAndSizes,
    qt_meta_data_ZN12ChatUserListE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12ChatUserListE_t,
        // Q_OBJECT / Q_GADGET
...
void ChatUserList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ChatUserList::*)();
            if (_q_method_type _q_method = &ChatUserList::sig_loading_chat_user; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ChatUserList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12ChatUserListE.stringdata0))
